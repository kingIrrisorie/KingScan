...
document.getElementById('add-button').addEventListener('click', function() {
    ...
    const mangaName = mangaInput.value.trim();

    if (mangaName) {
        mangas.push(mangaName);
        updateCarousel();
        mangaInput.value = ''; // Limpa o campo de entrada
    } else {
        alert('Por favor, insira o nome do manga.');
    }
});

function updateCarousel() {
    const carouselItems = document.getElementById('carousel-items');
    carouselItems.innerHTML = ''; // Limpa o carrossel
